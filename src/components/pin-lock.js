 ...
 * Handles profile selection, PIN entry, and new profile creation.
 */
import { getProfiles, createProfile, verifyPin } from '../db/database.js';
...
function unlock(profile) {
    ...
    els.activeUser.textContent = profile.name;
