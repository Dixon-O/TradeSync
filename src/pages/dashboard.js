/**
 * Dashboard Page v2
 * Daily summary with shared inventory stats and enhanced insights.
 */
import { getDashboardStats, getProducts, hasPrivilege } from '../db/database.js';
import { showToast } from '../components/toast.js';
import { getOfflineDurationText } from '../utils/network.js';

export async function renderDashboard(container, profileId, profile, { navigateTo, addToCart }) {
    const stats = await getDashboardStats(profileId);
    const products = await getProducts(); // Shared inventory
    ...
    const offlineMsg = getOfflineDurationText();

    container.innerHTML = `
        <div class="page active" id="page-dashboard">
            <div class="page-header">
                <div>
                    <h2>${greeting}, ${profile?.name || ''} ${profile?.role === 'admin' ? '👑' : ''}!</h2>
            ...
            ${offlineMsg ? `
                <div class="offline-banner">
                    <span>⚡</span> ${offlineMsg} — your data is safe locally
                </div>
            ` : ''}
            ...
            <div class="stats-grid">
                ...
                <div class="stat-card">
                    ...
                    <div class="stat-value" style="color: var(--accent-secondary);">KSh ${stats.totalOwed.toLocaleString()}</div>
                    ...
                    ${stats.lowStock.map(p => `
                        <div class="alert-item">
                            ...
                            <div class="alert-info">
                                ...
                                <div class="alert-desc">${p.stock} ${p.unit || 'pcs'} left — restock soon</div>
                            </div>
            ...
            ${topProducts.length > 0 && hasPrivilege(profile, 'canSell') ? `
                <div class="section-header">
                    <h3>⚡ Quick Sell</h3>
